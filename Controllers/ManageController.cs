...
using OnlineShopDemo.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ViewData["StatusMessage"] =
                message == ManageMessageId.ChangePasswordSuccess ? "您的密碼已經重新設定完成囉。"
                : message == ManageMessageId.SetPasswordSuccess ? "Your password has been set."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Your two-factor authentication provider has been set."
                : message == ManageMessageId.Error ? "非常不好意思，當您看到這個訊息時，代表有錯誤發生，請聯絡網站管理員"
                : message == ManageMessageId.AddPhoneSuccess ? "已註冊您的電話號碼。"
